/**
 * Talep onay / durum geçmişi (approval_history) için ortak etiket ve format yardımcıları.
 */
...
/** comments içinden bilinen durum ifadelerini çıkar */
...
export function mapApprovalHistoryToActivity(
  rows: RequestActivityRow[]
): RequestActivityItem[] {
  return rows
